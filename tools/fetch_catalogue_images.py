...
DUMMY = {
    ...
    "line:Electronics|Headphone": ["Apple AirPods Max Silver"],
    "line:Electronics|WH Headphones": ["Apple AirPods Max Silver"],
    "line:Electronics|QuietComfort": ["Apple AirPods Max Silver"],
    "line:Electronics|Major": ["Apple AirPods Max Silver"],
    "line:Electronics|Airdopes": ["Apple Airpods", "Beats Flex Wireless Earphones"],
    "line:Electronics|Buds": ["Apple Airpods", "Beats Flex Wireless Earphones"],
    "line:Electronics|Air Buds": ["Apple Airpods"],
    "line:Electronics|Galaxy Buds": ["Apple Airpods"],
    "line:Electronics|Rockerz": ["Beats Flex Wireless Earphones"],
    "line:Electronics|Tune": ["Beats Flex Wireless Earphones"],
    "line:Electronics|Speaker": ["Amazon Echo Plus", "Apple HomePod Mini Cosmic Grey"],
    "line:Electronics|SRS Speaker": ["Amazon Echo Plus"],
    "line:Electronics|Stone Speaker": ["Apple HomePod Mini Cosmic Grey"],
    "line:Electronics|SoundLink": ["Amazon Echo Plus"],
    "line:Electronics|Flip": ["Apple HomePod Mini Cosmic Grey"],
    "line:Electronics|Charge": ["Amazon Echo Plus"],
    "line:Electronics|Emberton": ["Apple HomePod Mini Cosmic Grey"],
    "line:Electronics|Acton": ["Amazon Echo Plus"],
    "line:Electronics|Partybox": ["Apple HomePod Mini Cosmic Grey"],
    "line:Electronics|Go": ["Amazon Echo Plus"],
    "line:Electronics|Audio System": ["Apple HomePod Mini Cosmic Grey"],
    "line:Electronics|Power Bank": ["Apple MagSafe Battery Pack"],
    "line:Electronics|Charger": ["Apple iPhone Charger", "Apple Airpower Wireless Charger"],
    "line:Men's Fashion|Polo T-Shirt": ["Gigabyte Aorus Men Tshirt"],
    "line:Men's Fashion|Round Neck T-Shirt": ["Gigabyte Aorus Men Tshirt"],
    "line:Garden & Outdoor|Ceramic Planter": ["Plant Pot"],
    "line:Furniture|Folding Bed": ["Annibale Colombo Bed"],
    "line:Beauty & Personal Care|Body Lotion": ["Vaseline Men Body and Face Lotion"],
    "line:Bags & Luggage|Duffel Bag": ["White Faux Leather Backpack"],
}
...
QUERIES = {
    ...
    "line:Electronics|Bravia Smart TV": "television screen",
    "line:Electronics|Smart TV": "television screen",
    ...
    "line:Men's Fashion|Regular Fit Jeans": "blue jeans denim",
    "line:Men's Fashion|Slim Fit Jeans": "blue jeans denim",
    "line:Men's Fashion|Kurta Pyjama Set": "suit",
    "line:Men's Fashion|Nehru Jacket": "suit",
    "line:Men's Fashion|Blazer": "suit",
    "line:Men's Fashion|Hoodie": "hoodie sweatshirt",
    ...
    "line:Women's Fashion|Wide Leg Jeans": "blue jeans denim",
    ...
    "line:Sports & Outdoors|Skipping Rope": "gym equipment",
    ...
    # Toys
    "line:Toys & Games|Building Blocks": "toy blocks children",
    "line:Toys & Games|Board Game": "board game",
    "line:Toys & Games|Jigsaw Puzzle": "jigsaw puzzle",
    "line:Toys & Games|Remote Control Car": "toy car",
    ...
    # Books
    "line:Books|Paperback Edition": "book cover",
    "line:Books|Hardcover Edition": "book cover",
    "line:Books|Illustrated Edition": "open book",
    # Automotive
    "line:Automotive|Engine Oil": "car",
    "line:Automotive|Car Battery": "car battery",
    ...
    # Office
    "line:Office Products|Notebook": "office desk supplies",
    "line:Office Products|Gel Pen Set": "pen writing",
    "line:Office Products|Sticky Notes": "office desk supplies",
    "line:Office Products|File Folder": "office supplies",
    "line:Office Products|Whiteboard Marker": "office desk supplies",
    "line:Office Products|Stapler": "office supplies",
    "line:Office Products|Desk Organiser": "office desk supplies",
    # Pets
    "line:Pet Supplies|Adult Dry Food": "dog",
    "line:Pet Supplies|Puppy Food": "dog",
    "line:Pet Supplies|Cat Food": "cat",
    "line:Pet Supplies|Chew Toy": "dog toy",
    ...
    "line:Baby|Feeding Bottle": "baby bottle",
    "line:Baby|Baby Carrier": "baby",
    "line:Baby|Sterilizer": "baby",
    "line:Baby|Baby Powder": "baby",
    # Bags & luggage
    "line:Bags & Luggage|Cabin Trolley": "suitcase luggage",
    "line:Bags & Luggage|Check-in Trolley": "suitcase luggage",
    ...
    "line:Musical Instruments|Cajon": "drum percussion",
    ...
    "line:Tools & Home Improvement|Hammer": "hammer tools",
    "line:Tools & Home Improvement|Wrench Set": "tools",
    # Garden
    "line:Garden & Outdoor|Seed Kit": "seeds planting",
    "line:Garden & Outdoor|Ceramic Planter": "plant pot",
    ...
    "line:Automotive|Seat Cover": "car interior seat",
}
...
DEPARTMENT_QUERIES = {
    ...
    "dept:Video Games": "video game console",
}
